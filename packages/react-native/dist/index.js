...
const getTargetFd = ({ value, optionName, fdNumber, direction })=>{
    ...
    if (__WEBPACK_EXTERNAL_MODULE_node_tty_c64aab7e__["default"].isatty(targetFdNumber)) throw new TypeError(`The \`${optionName}: ${serializeOptionValue(value)}\` option is invalid: it cannot be a TTY with synchronous methods.`);
    return {
        type: 'uint8Array',
...
const addPropertiesSync = {
    input: {
        ...
        fileUrl: ({ value })=>({
                contents: [
                    bufferToUint8Array((0, __WEBPACK_EXTERNAL_MODULE_node_fs_5ea92f0c__.readFileSync)(value))
                ]
            }),
        filePath: ({ value: { file } })=>({
                contents: [
...
const addPropertiesAsync = {
    input: {
        ...
        fileUrl: ({ value })=>({
                stream: (0, __WEBPACK_EXTERNAL_MODULE_node_fs_5ea92f0c__.createReadStream)(value)
            }),
        filePath: ({ value: { file } })=>({
                stream: (0, __WEBPACK_EXTERNAL_MODULE_node_fs_5ea92f0c__.createReadStream)(file)
            }),
        webStream: ({ value })=>({
                stream: __WEBPACK_EXTERNAL_MODULE_node_stream_444d1c2b__.Readable.fromWeb(value)
            }),
        iterable: ({ value })=>({
                stream: __WEBPACK_EXTERNAL_MODULE_node_stream_444d1c2b__.Readable.from(value)
            }),
        asyncIterable: ({ value })=>({
                stream: __WEBPACK_EXTERNAL_MODULE_node_stream_444d1c2b__.Readable.from(value)
            }),
        ...
        uint8Array: ({ value })=>({
                stream: __WEBPACK_EXTERNAL_MODULE_node_stream_444d1c2b__.Readable.from(__WEBPACK_EXTERNAL_MODULE_node_buffer_fb286294__.Buffer.from(value))
            })
    },
    output: {
        ...handle_async_addProperties,
        fileUrl: ({ value })=>({
                stream: (0, __WEBPACK_EXTERNAL_MODULE_node_fs_5ea92f0c__.createWriteStream)(value)
            }),
        filePath: ({ value: { file, append } })=>({
        ...
        webStream: ({ value })=>({
                stream: __WEBPACK_EXTERNAL_MODULE_node_stream_444d1c2b__.Writable.fromWeb(value)
            }),
...
const src_rslib_entry_global = globalThis;
...
class Emitter {
    ...
    id = Math.random();
    constructor(){
        if (src_rslib_entry_global[kExitEmitter]) return src_rslib_entry_global[kExitEmitter];
        ObjectDefineProperty(src_rslib_entry_global, kExitEmitter, {
            value: this,
            writable: false,
            enumerable: false,
            configurable: false
...
async function exportExpoConfig({ expoConfigPath }) {
    ...
    try {
        ...
        await __WEBPACK_EXTERNAL_MODULE_node_fs_promises_153e37e0__.writeFile(__WEBPACK_EXTERNAL_MODULE_node_path_c5b9b54f__.join(expoConfigPath, "expoConfig.json"), stdout);
...
async function deploy() {
    ...
    try {
        ...
        __WEBPACK_EXTERNAL_MODULE__clack_prompts_3cae1695__.note(JSON.stringify({
