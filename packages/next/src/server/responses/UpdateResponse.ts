<<<<<<< Updated upstream:packages/next/src/responses/UpdateResponse.ts
...
=======
import type { Directive, Extensions, Manifest } from "@/server/types";
import { convertObjectToDictionary } from "@/server/utils/convertObjectToDictionary";
>>>>>>> Stashed changes:packages/next/src/server/responses/UpdateResponse.ts
